...
@Component
public class ImageFacadeImplV2 implements ImageFacade {
...
//        }
    ...
    @Override
    public void addImageToCollection(String imageFileName) {
    ...
    @Override
    public String describeCollection(String collectionId) {
        throw new UnsupportedOperationException("Missing implementation");
    }
}
